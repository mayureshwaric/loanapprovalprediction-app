...
def predict():
    ...
    if request.method == 'POST':
        ...
        if prediction==0:
            return render_template('application.html',prediction_neg="Sorry, your loan application is rejected.")
        else:
            return render_template('application.html',prediction_pos="Congratulations! your loan application is approved.")
    else:
        return render_template('application.html')
